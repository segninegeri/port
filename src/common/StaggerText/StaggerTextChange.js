            ...
            >
                {
                    letters.map((item, i) => {
                        return (
                                ...
                                style={{
                                    transform:
                                        animate ?
                                            ...
                                            `translateY(0${props.unit == null || props.unit == "" ? "px" : props.unit})`
                                    ,
                                    ...
                                    color: `${props.color == "" || props.color == null ? "#fff" : props.color}`,
                            ...
                            >
                                {
                                    item == "&nbsp;" ? <span key={i} style={{ fontSize: `${props.wordSpacing == null || props.wordSpacing == 0 ? props.fontSize == 0 || props.fontSize == null ? 48 : props.fontSize : props.wordSpacing}${props.unit == null || props.unit == "" ? "px" : props.unit}` }} >&nbsp;</span> : item
                                }
                            </span>
                        )
                    })}
                                ...
                                style={{
                                    transform:
                                        animate ?
                                            ...
                                            `translateY(${props.direction == null || props.direction == "" || props.direction !== "down" ?
                                                0
                                                : props.fontSize == null || props.fontSize == 0 ? -48 * 2 : -props.fontSize * 2
                                            }${props.unit == null || props.unit == "" ? "px" : props.unit})`
                                    ,
